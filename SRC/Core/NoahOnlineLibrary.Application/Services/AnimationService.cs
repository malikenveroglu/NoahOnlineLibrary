    ...
    public class AnimationService 
    {
        ...
        public void LeaveTheLibrary()
        {
            for (int i = 0; i < 70; i++)
            {
                ...
                Console.WriteLine(new string(' ', i) + @"       )_________)            ,------,         ");
                Console.WriteLine(new string(' ', i) + @"     _______________          )_______)                       ");
                Console.WriteLine(new string(' ', i) + @"    )                )      _____________        _____");
                Console.WriteLine(new string(' ', i) + @"    )                 )     )            )      )      ) ");
                Console.WriteLine(new string(' ', i) + @"    )                  )    )             )     )       ) ");
